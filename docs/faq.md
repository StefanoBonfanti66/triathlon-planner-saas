...
**D: L'app è gratuita?**
R: Sì, il sistema è gratuito per i team. I costi infrastrutturali (Supabase, Vercel) sono sostenuti dallo sviluppatore.
...
R: Controlla lo spam. Se ancora non arriva, l'admin può crearti con una password temporanea.

**D: Il login dà errore "Database error querying schema".**
...
R: No, è opzionale. Se inserisci l'email, l'atleta riceve un invito e può loggarsi. Se la lasci vuota, viene creata solo l'anagrafica.

**D: L'atleta non riceve l'email di invito.**
R: Prova a crearlo con una password temporanea (es. Gara2026!). Può loggarsi subito con quella.
...
R: Imposta il flag is_viewer sul suo profilo. Avrà accesso in sola lettura a tutto.
...
**D: Il repository è pubblico, ci sono rischi?**
...
R: Chiedi al tuo Team Admin di configurare l'ID del gruppo Telegram nelle impostazioni team. Il bot invierà notifiche automatiche.
